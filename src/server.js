...
// ✅ (si existe) ruta ozone: /ozone/product
let ozoneRoute = null;
try {
  ozoneRoute = require('./routes/ozone');
} catch (e) {
  console.log('[boot] ozone route not found, skipping');
}
...
// (Opcional) alias más corto por comodidad
